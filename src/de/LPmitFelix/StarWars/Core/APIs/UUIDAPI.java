...
public class UUIDAPI {
     ...
     *
     * @see UUIDAPI#getUUIDAt(String, long)
     */
    ...
    public static UUID getUUIDAt(String name, long timestamp) {
        ...
        try {
            ...
            UUIDAPI data = gson.fromJson(new BufferedReader(new InputStreamReader(connection.getInputStream())), UUIDAPI.class);
    ...
    public static String getName(UUID uuid) {
        ...
        try {
            ...
            connection.setReadTimeout(5000);
            UUIDAPI[] nameHistory = gson.fromJson(new BufferedReader(new InputStreamReader(connection.getInputStream())), UUIDAPI[].class);
            UUIDAPI currentNameData = nameHistory[nameHistory.length - 1];
